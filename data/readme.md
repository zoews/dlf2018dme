The following data files should be contained in this folder. In addition a link to a Google Drive folder is provided for access to larger geotiff files:
